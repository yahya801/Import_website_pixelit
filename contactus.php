                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-4 col-md-6">
                            <div class="conact-info-wrap mt-30">
                                <h5 class="heading mb-20">Pakistan</h5>
                                <ul class="conact-info__list">
                                    <li>R4, Opposite Gohar Sultan Masjid<br>
                                       ...
                                       Block 17, Gulistan-e-johar <br>
                                           Karachi, Sindh</li>
                                    <li><a href="#"
                                            class="hover-style-link text-color-primary">customercare@bringitin.pk</a>
                                    </li>
    ...
    <!-- <div class="col-lg-4 col-md-6">
                            <div class="conact-info-wrap mt-30">
                                ...
                                <ul class="conact-info__list">
                                    ...
                                    <li><a href="#"
                                            class="hover-style-link text-color-primary">contact.newyork@mitech.com</a>
                                    </li>
    ...
    <!-- <div class="col-lg-4 col-md-6">
                            <div class="conact-info-wrap mt-30">
                                ...
                                <ul class="conact-info__list">
                                    ...
                                    <li><a href="#"
                                            class="hover-style-link text-color-primary">contact.russia@mitech.com</a>
                                    </li>
